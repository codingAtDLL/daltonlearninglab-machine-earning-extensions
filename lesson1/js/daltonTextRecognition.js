(function(ext) {
    ...
    var descriptor = {
        blocks: [
            [' ', 'new Text Recognition', 'newTextRecognition'],
            [' ', 'reset Text Recognition', 'newTextRecognition'],
            [' ', 'add training record %s with label %s', 'addTrainingRecord', 'text', 'label'],
            ['w', 'train', 'train'],
            ['R', 'classify text: %s', 'classifyText', 'text'],
            ['R', 'classify text: %s and return csv', 'classifyTextAsCSV', 'text'],
