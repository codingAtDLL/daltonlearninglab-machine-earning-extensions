...
module.exports = {
	...
	TicTacToe: require('./js/TicTacToe'),
	lodash: require('lodash'),
}
window.tictactoe = module.exports;
window.TicTacToe = window.tictactoe.TicTacToe;
window.Player = window.tictactoe.Player;
window.lodash = window.tictactoe.lodash;
},{"./js/Player":2,"./js/Q":3,"./js/Square":4,"./js/TicTacToe":5,"lodash":8}],2:[function(require,module,exports){
...
},{"backbone":6,"jquery":7}],5:[function(require,module,exports){
var lodash = require('lodash');
var $ = require('jquery');
var Backbone = require('backbone');
...
/*    
    ...
    checkForCat() {
        var result = lodash.flatten(this.board).every(cell => cell);
        return result;
    },
...
},{"./Player":2,"./Square":4,"backbone":6,"jquery":7,"lodash":8}],6:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
